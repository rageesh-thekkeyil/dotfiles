...
#gcp aliases
alias cassandra-retail-dev="gcloud compute ssh cassandra-pricing-us-east1-c-seed-1 --tunnel-through-iap --zone us-east1-c --project hd-pricing-dev  --ssh-flag=\"-L9042:localhost:9042\""
